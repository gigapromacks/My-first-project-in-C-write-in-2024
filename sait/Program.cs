...
namespace sait
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("med - следить за процесом ");
            Console.WriteLine("avtobus - avtobus ");
            Console.WriteLine("a (ENG)- слежка ");
            Console.WriteLine("pro - все процессы");
      ...
      static void prover()
        {
           int gg = 10000;
            ...
            Console.WriteLine("1 - chrome     2 - tanks blitz     3 - fornite    4 - steam  5 - сам " +
                "" +
                "" +
                "7 - ввести интервал между проверской");
        ...
        public static void lisproc()
        {
            ...
            Console.WriteLine($"\nВсего процессов: {allProcesses.Length}");
            Console.ReadLine();
        }
            ...
            if (cheld == true && tankd == true)
            {
                ...
                switch (y)
                {
                    case 0://boy [chit]
                        ...
                        int am = r.Next(1, 25);
                        int am1 = r.Next(1000, 250000);
                        int am2 = r.Next(1000, 25000);
                        int am3 = r.Next(1000, 25000);
                        int am4 = r.Next(1, 250);
                        if (am1 < v)
                        {
